...
public class DiceGame extends JFrame{
    ...
    /** Insert unique ActionEvent 
	 *  @param value	ActionEvent that causes response
	 */
	 ...
	 *  @param value	String sets user names, int set life points
	 */
